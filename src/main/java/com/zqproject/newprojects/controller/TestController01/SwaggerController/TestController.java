package com.zqproject.newprojects.controller.TestController01.SwaggerController;
 ...
 * ====================================================
 * 访问地址
 * http://localhost:8080/newprojects/swagger-ui.html
 */
@Controller
public class TestController {
    ...
    @RequestMapping(value = "/getUserById1/{id}", method = RequestMethod.GET)
    ...
    @RequestMapping(value = "/updateById1/{id}", method = RequestMethod.PUT)
    ...
    @ApiImplicitParam(name = "id", value = "用户ID", required = true, dataType = "Long", paramType = "path")
    @RequestMapping(value = "/deleteById1/{id}", method = RequestMethod.DELETE)
    ...
    @ApiIgnore//使用该注解忽略这个API
    @RequestMapping(value = "/ignoreApi1", method = RequestMethod.GET)
    public String  ignoreApi1() {
